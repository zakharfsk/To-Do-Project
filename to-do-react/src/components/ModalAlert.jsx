...
function ModalAlert({title, description, showAlert}) {
                        ...
                        >
                            <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-zinc-900 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                                ...
                                <div className="bg-zinc-900 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                                    <button
                                        type="button"
                                        className="mt-3 inline-flex w-full justify-center rounded-md px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-gray-50 hover:text-black sm:mt-0 sm:w-auto"
                                        onClick={() => {
                                            setOpen(false)
                                            showAlert({show: false, title: '', description: ''})
                                        }}
                                        ref={cancelButtonRef}
                                    >
                                        Cancel
